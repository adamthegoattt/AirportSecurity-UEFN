...
BILLBOARD_DEFAULTS = {
    ...
    "TL_BOARD_SecondaryControl": "RED | NO PASS\nLOCKED - COMPLETE CHECKS",
...
BOXES = [
    ...
    # Primary console: red NO PASS on the left and green PASS on the right.
    ("CheckpointDecisionBase", (700, -1770, 165), (520, 260, 154), "MIDNIGHT_BLUE"),
    ("CheckpointDecisionTop", (700, -1770, 251), (520, 260, 18), "GRAY"),
    ("CheckpointDecisionDivider", (700, -1770, 276), (18, 210, 32), "SILVER"),
    ("CheckpointNoPassSymbolA", (570, -1770, 307), (70, 18, 12), "WHITE", 45.0),
    ("CheckpointNoPassSymbolB", (570, -1770, 307), (70, 18, 12), "WHITE", -45.0),
    ("CheckpointPassSymbolA", (807, -1775, 300), (50, 18, 12), "WHITE", -40.0),
    ("CheckpointPassSymbolB", (843, -1764, 313), (85, 18, 12), "WHITE", 42.0),
    # DETAIN remains a later explicit choice on a separate red station.
    ("CheckpointJailSymbolA", (1300, -2100, 307), (70, 18, 12), "WHITE", 45.0),
    ("CheckpointJailSymbolB", (1300, -2100, 307), (70, 18, 12), "WHITE", -45.0),
    ...
    ("LargeDetectorControlPedestal", (1040, -1770, 143), (100, 120, 110), "MIDNIGHT_BLUE"),
    ("LargeDetectorControlFace", (1040, -1706, 155), (80, 8, 45), "AQUA"),
...
SHAPES = [
    ...
    ("CheckpointNoPassRim", "cylinder", (570, -1770, 277), (150, 150, 36), "SILVER"),
    ("CheckpointNoPassCap", "cylinder", (570, -1770, 297), (122, 122, 44), "RED_ORANGE"),
    ("CheckpointPassRim", "cylinder", (830, -1770, 277), (150, 150, 36), "SILVER"),
    ("CheckpointPassCap", "cylinder", (830, -1770, 297), (122, 122, 44), "APPLE_GREEN"),
    ("CheckpointJailRim", "cylinder", (1300, -2100, 277), (150, 150, 36), "SILVER"),
    ("CheckpointJailCap", "cylinder", (1300, -2100, 297), (122, 122, 44), "RED_ORANGE"),
]


LABELS = [
    ("CheckpointNoPassLabel", (570, -1595, 405), "NO PASS\nSECONDARY"),
    ("CheckpointPassLabel", (830, -1595, 405), "PASS\nCLEAR"),
    ("CheckpointJailLabel", (1300, -1925, 405), "JAIL\nDETAIN"),
...
for actor in all_actors():
    if actor.get_actor_label() == "TL_BTN_Scan":
        actor.set_actor_location(unreal.Vector(1040.0, -1770.0, 145.0), False, False)
        make_decorative_nonblocking(actor)
        scan_button_relocated = True
        break

# Reuse the authoritative, already-bound CLEAR, SECONDARY, and DETAIN Button
# devices as PASS, NO PASS, and later DETAIN backends. Moving the existing actors preserves
